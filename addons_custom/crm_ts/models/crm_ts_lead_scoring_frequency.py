...
class LeadScoringFrequency(models.Model):
    _name = 'crm_ts.lead.scoring.frequency'
    ...
    team_id = fields.Many2one('crm_ts.team', 'Sales Team', ondelete="cascade")

class FrequencyField(models.Model):
    _name = 'crm_ts.lead.scoring.frequency.field'
    ...
    field_id = fields.Many2one(
        'ir.model.fields', domain=[('model_id.model', '=', 'crm_ts.lead')], required=True,
        ondelete='cascade',
    )
