...
class CrmTsLeadLost(models.TransientModel):
    _name = 'crm_ts.lead.lost'
    _description = 'Get Lost Reason'

    lead_ids = fields.Many2many('crm_ts.lead', string='Leads')
    lost_reason_id = fields.Many2one('crm_ts.lost.reason', 'Lost Reason')
