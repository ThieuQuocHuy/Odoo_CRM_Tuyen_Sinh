...
from odoo.addons.crm_ts.tests.test_crm_ts_lead_assignment import TestLeadAssignCommon
from odoo.tests.common import tagged
from odoo.tools import mute_logger


@tagged('lead_assign', 'crm_ts_performance', 'post_install', '-at_install')
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    @mute_logger('odoo.models.unlink', 'odoo.addons.crm_ts.models.crm_ts_team', 'odoo.addons.crm_ts.models.crm_ts_team_member')
