...
class TestCRMLead(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.lead_generic = cls.env['crm_ts.lead'].create({
            'country_id': country_us_id,
        ...
        cls.lead_company = cls.env['crm_ts.lead'].create({
            'country_id': country_us_id,
        ...
        # duplicates
        cls.lead_generic_email_dupes = cls.env['crm_ts.lead'].create([
        ...
        cls.lead_generic_email_notdupes = cls.env['crm_ts.lead'].create([
        ...
        cls.lead_company_email_dupes = cls.env['crm_ts.lead'].create([
            # email based: normalized version used for email domain criterion
            {
        ...
        cls.lead_company_email_notdupes = cls.env['crm_ts.lead'].create([
    ...
    def test_crm_ts_lead_duplicates_fetch(self):
    ...
    @users('user_sales_leads')
    def test_crm_ts_lead_email_domain_criterion(self):
