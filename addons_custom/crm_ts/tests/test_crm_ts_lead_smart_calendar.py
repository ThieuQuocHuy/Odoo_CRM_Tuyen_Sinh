...
class TestCRMLeadSmartCalendar(TestCrmCommon):
    ...
    def test_meeting_view_parameters_1(self):
        lead_smart_calendar_1 = self.env['crm_ts.lead'].create({'name': 'Lead 1  - user_NY_en_US'})
        ...
        lead_smart_calendar_2 = self.env['crm_ts.lead'].create({'name': 'Lead 2 - user_NY_en_US'})
    ...
    def test_meeting_view_parameters_2(self):
        ...
        lead_smart_calendar_1 = self.env['crm_ts.lead'].create({'name': 'Lead 1 - user_UTC_pt_PT'})
        ...
        lead_smart_calendar_2 = self.env['crm_ts.lead'].create({'name': 'Lead 2 - user_UTC_pt_PT'})
