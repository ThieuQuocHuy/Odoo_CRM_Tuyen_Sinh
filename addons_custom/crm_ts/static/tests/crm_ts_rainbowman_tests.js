...
import "@crm_ts/../tests/mock_server";
...
function getMockRpc(assert) {
    return async (route, args, performRpc) => {
        ...
        if (args.model === 'crm_ts.lead' && args.method === 'get_rainbowman_message') {
            ...
            models: {
                ...
                'crm_ts.lead': {
                    fields: {
                        ...
                        team_id: { string: 'Sales Team', type: 'many2one', relation: 'crm_ts.team' },
