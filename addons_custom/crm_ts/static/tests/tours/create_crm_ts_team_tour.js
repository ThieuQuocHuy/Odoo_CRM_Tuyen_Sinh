...
registry.category("web_tour.tours").add('create_crm_ts_team_tour', {
    url: "/odoo",
    steps: () => [
    ...stepUtils.goToAppSteps('crm_ts.crm_ts_menu_root'),
{
    trigger: 'button[data-menu-xmlid="crm_ts.crm_ts_menu_config"]',
    run: "click",
}, {
    trigger: 'a[data-menu-xmlid="crm_ts.crm_ts_team_config"]',
    run: "click",
}, {
