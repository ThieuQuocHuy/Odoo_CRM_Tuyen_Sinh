...
registry.category("web_tour.tours").add('crm_ts_forecast', {
    url: "/odoo",
    steps: () => [
    stepUtils.showAppsMenuItem(),
    {
        trigger: ".o_app[data-menu-xmlid='crm_ts.crm_ts_menu_root']",
        content: "open crm_ts app",
        run: "click",
    }, {
        trigger: '.dropdown-toggle[data-menu-xmlid="crm_ts.crm_ts_menu_report"]',
        content: 'Open Reporting menu',
        run: 'click',
    }, {
        trigger: '.dropdown-item[data-menu-xmlid="crm_ts.crm_ts_menu_forecast"]',
