...
import { fillTemporalService } from "@crm_ts/views/fill_temporal_service";
...
QUnit.module('Crm Fill Temporal Service', {
    ...
    QUnit.test("Forecast on months, until the end of the year of the latest data", async function (assert) {
        ...
        this.testKanbanView.serverData.models['crm_ts.lead'].records = [
        ...
        const kanban = await makeView({
            ...
            mockRPC: function (route, args) {
                if (route === '/web/dataset/call_kw/crm_ts.lead/web_read_group') {
