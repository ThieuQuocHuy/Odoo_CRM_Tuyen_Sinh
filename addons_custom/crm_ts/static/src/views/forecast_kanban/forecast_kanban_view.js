...
import { ForecastKanbanController } from "@crm_ts/views/forecast_kanban/forecast_kanban_controller";
import { CrmKanbanArchParser } from "@crm_ts/views/crm_ts_kanban/crm_ts_kanban_arch_parser";
import { ForecastKanbanModel } from "@crm_ts/views/forecast_kanban/forecast_kanban_model";
import { ForecastKanbanRenderer } from "@crm_ts/views/forecast_kanban/forecast_kanban_renderer";
import { ForecastSearchModel } from "@crm_ts/views/forecast_search_model";
