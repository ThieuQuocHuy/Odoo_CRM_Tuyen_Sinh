...
class SaleOrder(models.Model):
    ...
    # Custom linkage and info from CRM TS lead
    crm_ts_lead_id = fields.Many2one(
        comodel_name='crm_ts.lead', string='Lead (CRM TS)',
        help='Source CRM TS lead that created this quotation/order')
    crm_ts_student_name = fields.Char(
        string='Tên học sinh',
        help='Student name coming from CRM TS lead')
    crm_ts_interested_facility = fields.Char(
        string='Cơ sở quan tâm',
        help='Interested facility copied from CRM TS lead')
